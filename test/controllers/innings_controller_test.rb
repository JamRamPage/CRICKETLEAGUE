...
class InningsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update innings" do
    patch match_innings_url(@match, @innings), params: { innings: { byes: @innings.byes, hometeambatted: @innings.hometeambatted, legbyes: @innings.legbyes, match_id: @match.id, penalties: @innings.penalties } }
